...
/**
 * GitHub — the official mark (MIT), inlined verbatim from index.html:71.
 *
 ...
 *
 * Two paths inside the mockup's <g> — the Octocat silhouette and the tail of
 * the "tentacle", the latter split into six separate strokes. `fillRule` and
 * `clipRule` on the silhouette punch the eye and the body out of the circle;
 * dropping them fills it solid.
 *
